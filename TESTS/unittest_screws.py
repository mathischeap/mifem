...
def test_SCREWS_NO2_sending_an_email_to_admin(force_to_do=False):
    ...
    if rAnk == mAster_rank:
        ...
        try:
            ...
            with open('TESTS/__unittest_files__/___private_developer_email_admin_1___.txt', 'r') as f:
            ...
            with open('TESTS/__unittest_files__/___private_developer_email_admin_2___.txt', 'r') as f:
            ...
            if force_to_do or i > 0.98 or D1 > 24 * 14: # 2% chance to do this test or did not test for more than 14 days
                ...
                if code == 1:
                    with open('TESTS/__unittest_files__/___private_developer_email_admin_1___.txt', 'w') as f:
                        f.write(time.ctime())
                    if force_to_do:
            ...
            if force_to_do or i > 0.98 or D2 > 24 * 7: # 2% chance to do this test or did not test for more than 7 days
                ...
                if code == 1:
                    with open('TESTS/__unittest_files__/___private_developer_email_admin_2___.txt', 'w') as f:
                        f.write(time.ctime())
                    if force_to_do:
