...
from TOOLS.linear_algebra.__DEPRECATED__.data_structure_old0 import GlobalMatrix as GlobalMatrixOld
import TOOLS.linear_algebra.__DEPRECATED__.gmres as gmres
