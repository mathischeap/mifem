...
class CSCG_Standard_Form_Cochain_BASE(FrozenOnly):
    ...
    def ___PRIVATE_do_gather_to_master_and_make_them_region_wise_local_index_grouped___(self):
        """make it region-wise-element-local-indexed, thus we can save it and when read a form, we can always have the
    ...
    def ___PRIVATE_do_distribute_region_wise_local_index_grouped_cochain_to_local___(self, RW_LI_COCHAIN):
        ...
        cochain. The region-wise grouped cochain must be a full cochain in all cores.
    ...
    def globe(self):
        ...
        if self._sf_.IS_hybrid or (self._sf_.ndim == self._sf_.k):
            ...
            # otherwise, we make a master domiating distributed vector.
    ...
    def globe(self, globe):
        """
        This process is complex but it make sure that the distribution is correct for all cases.
