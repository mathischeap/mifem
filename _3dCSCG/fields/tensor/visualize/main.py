...
from _3dCSCG.fields.tensor.visualize.matplot import _3dCSCG_TensorField_matplot_Visualize
...
class _3dCSCG_TensorField_Visualize(FrozenOnly):
    """"""
    def __init__(self, f):
        """"""
        self._f_ = f
        self._matplot_ = _3dCSCG_TensorField_matplot_Visualize(f)
        self._freeze_self_()
