...
from _3dCSCG.fields.vector.do.cross_product.helpers.cp1 import ___VF_CROSS_PRODUCT_HELPER_1___
        ...
        if vector.__class__.__name__ == '_3dCSCG_VectorField':
            ...
            if self._vf_.ftype == 'standard':
                if vector.ftype == 'standard':
                    ...
                    vector_class = getattr(import_module('_3dCSCG.fields.vector.main'),
                                           '_3dCSCG_VectorField')
