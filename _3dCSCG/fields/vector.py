...
class _3dCSCG_VectorField(_3dCSCG_Continuous_FORM_BASE, ndim=3):
    ...
    def flux(self):
        ...
        if self.ftype == 'standard':
            ...
            scalar_class = getattr(import_module('_3dCSCG.fields.scalar'), '_3dCSCG_ScalarField')
...
class _3dCSCG_VectorField_Numerical(FrozenOnly):
    ...
    def gradient(self):
        ...
        if self._vf_.ftype == 'standard':
            ...
            tensor_class = getattr(import_module('_3dCSCG.fields.tensor'), '_3dCSCG_TensorField')
