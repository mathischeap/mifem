...
def test_ADF_NO1_general_tests_standard_forms():
    ...
    DF0 = read('_3dCSCG/TESTS/__unittest_files__/test_ADF_NO1_df0.mi')
    DF0_error = DF0.prime.error.L()
    assert df0_error == DF0_error
    ...
    DF1 = read('_3dCSCG/TESTS/__unittest_files__/test_ADF_NO1_df1.mi')
    DF1_error = DF1.prime.error.L()
    assert df1_error == DF1_error
    ...
    DF2 = read('_3dCSCG/TESTS/__unittest_files__/test_ADF_NO1_df2.mi')
    DF2_error = DF2.prime.error.L()
    assert df2_error == DF2_error
    ...
    DF3 = read('_3dCSCG/TESTS/__unittest_files__/test_ADF_NO1_df3.mi')
    DF3_error = DF3.prime.error.L()

    assert abs(df3_error - DF3_error) < 1e-10
