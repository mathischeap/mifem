...
from _3dCSCG.form.standard.numbering.main import _3dCSCG_Standard_Form_Numbering
from _3dCSCG.form.standard.visualize.main import _3dCSCG_FormVisualize
from _3dCSCG.form.standard.export.main import _3dCSC_Standard_Form_Export
...
class _3dCSCG_Standard_Form_Coboundary(CSCG_Standard_Form_Coboundary_BASE):
    ...
    def ___PRIVATE_next_class___(self):
        ...
        k = self._sf_.k
        nextPath = f'_3dCSCG.form.standard._{k+1}_form'
        nextName = f'_{k+1}Form'
...
class _3dCSCG_Standard_Form_Matrices(FrozenOnly):
    ...
    def selective(self):
        ...
        if self._S_ is None:
            k = self._sf_.k
            formName = f'_{int(k)}Trace'
            S = getattr(self._sf_.space.selective_matrix, formName)[0]
            self._S_ = \
                EWC_SparseMatrix(self._sf_.mesh.elements, S, 'constant')
        return self._S_
