...
from _3dCSCG.form.trace.numbering.main import _3dCSCG_Trace_Numbering

from _3dCSCG.form.trace.visualize.main import _3dCSCG_Trace_Visualize
...
class _3dCSCG_Trace_Matrices(FrozenOnly):
    ...
    @property
    def selective(self):
        """Return the selective matrix. Like the trace matrix but without minus sign."""
        if self._S_ is None:
            k = self._tf_.k
            formName = f'_{int(k)}Trace'
