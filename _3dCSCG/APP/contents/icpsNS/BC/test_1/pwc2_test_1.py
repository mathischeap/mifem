# -*- coding: utf-8 -*-
"""
$ mpiexec python _3dCSCG\APP\contents\icpsNS\BC\test_1\pwc2_test_1.py
...
t = 5
steps=800
start_with = '_3dCSCG/APP/contents/icpsNS/BC/test_1/PWC2_uuww_N2k10_t1.mi'
half_step_u1w2 = '_3dCSCG/APP/contents/icpsNS/BC/test_1/PWC2_u1w2_N2k10_t1h.mi'



# no changes below .............
element_layout = [20, 10, [1,2,4,8,16,32,32,32,32,16,8,4,2,1]]
N = 2
F = 1
nu = 0.1
rho = 1
...
conserving = False
RDF_filename = f'RDF_PWC2_TEST_1_t0{int(t0)}_t{int(t)}'
name         = f'Iterator_PWC2_TEST_1_t0{int(t0)}_t{int(t)}'
...
def SOLVER(tk, tk1):
    ...
    if abs(round(tk1) - tk1) < 1e-8: save([u1, u2, w1, w2],
        f'PWC2_uuww_TEST_1_t{int(round(tk1))}')
    ...
    if abs(round(tk1) - tk1) < 1e-8: save([u1, w2],
        f'PWC2_u1w2_TEST_1_t{int(round(tk1))}h')
