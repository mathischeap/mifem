...
class icpsNS_Base(Base):
    ...
    def ___check_self___(self):
        ...
        for time in times:
            ...
            Pu = NumericalPartialDerivative3(u, *rst)
            ...
            Pv = NumericalPartialDerivative3(v, *rst)
            ...
            Pw = NumericalPartialDerivative3(w, *rst)
            ...
            Pwx = NumericalPartialDerivative3(wx, *rst)
            Pwy = NumericalPartialDerivative3(wy, *rst)
            Pwz = NumericalPartialDerivative3(wz, *rst)
        ...
        try:
            ...
            for time in times:
                ...
                Pp = NumericalPartialDerivative3(p, *rst)
                ...
                Pu_x = NumericalPartialDerivative3(u_x, *rst)
                assert Pu_x.check_partial_x(u_xx)
                Pu_y = NumericalPartialDerivative3(u_y, *rst)
                assert Pu_y.check_partial_y(u_yy)
                Pu_z = NumericalPartialDerivative3(u_z, *rst)
                assert Pu_z.check_partial_z(u_zz)
                Pv_x = NumericalPartialDerivative3(v_x, *rst)
                assert Pv_x.check_partial_x(v_xx)
                Pv_y = NumericalPartialDerivative3(v_y, *rst)
                assert Pv_y.check_partial_y(v_yy)
                Pv_z = NumericalPartialDerivative3(v_z, *rst)
                assert Pv_z.check_partial_z(v_zz)
                Pw_x = NumericalPartialDerivative3(w_x, *rst)
                assert Pw_x.check_partial_x(w_xx)
                Pw_y = NumericalPartialDerivative3(w_y, *rst)
                assert Pw_y.check_partial_y(w_yy)
                Pw_z = NumericalPartialDerivative3(w_z, *rst)
