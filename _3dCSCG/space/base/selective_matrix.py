...
class SelectiveMatrix(FrozenOnly):
    ...
    @property
    def _0Node(self):
        """The selective matrix for the 0-node-form."""
    ...
    def _0Edge(self):
        ...
        p = self._FS_.p
        num_basis_0form = self._FS_.num_basis._0Form[0]
        LNf = self._FS_.local_numbering._0Form[0]
        LNe = self._FS_.local_numbering._0Edge
    ...
    def _1Edge(self):
        ...
        p = self._FS_.p
        num_basis_1form = self._FS_.num_basis._1Form[0]

        LNf = self._FS_.local_numbering._1Form
        LNe = self._FS_.local_numbering._1Edge
...
if __name__ == '__main__':
    ...
    print(space._selective_matrix_._1Edge)