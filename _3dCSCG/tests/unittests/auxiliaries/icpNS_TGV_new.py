...
def NoHy_TGV_NEW(N=2, k=4, t=15, steps=480, Re=500,
    ...
    def SOLVER(tk, tk1):
        ...
        oR,_,_,_,mo = solve(SYS_oA, SYS_ob, X0, atol=atol, restart=int(restart*1.2), maxiter=maxiter)
        ...
        X0 = INN_R[0]
        iR,_,_,_,mi = solve(SYS_iA, SYS_ib, X0, atol=atol, restart=restart, maxiter=maxiter)
