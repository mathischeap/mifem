...
>> mpiexec python _3dCSCG/tests/unittests/main.py

This calls all cores. To call particular number of cores, say ``3`` cores, do

>> mpiexec -n 3 python _3dCSCG/tests/unittests/main.py
...
from _3dCSCG.tests.unittests.standard_forms import *
from _3dCSCG.tests.unittests.fields import *
from _3dCSCG.tests.unittests.spaces import *
from _3dCSCG.tests.unittests.mesh import *
from _3dCSCG.tests.unittests.Naive_numbering import *
from _3dCSCG.tests.unittests.APP import *
from _3dCSCG.tests.unittests.ADF import *
from _3dCSCG.tests.unittests.trace_forms import *
from _3dCSCG.tests.unittests.edge_forms import *
