...
def random_2D_mesh_of_elements_around(elements_num,
...
def random_2D_space_of_overall_degrees_around(overall_degrees):
    """
...
def random_2D_mesh_and_space_of_total_load_around(total_load, **kwargs):
    """
    ...
    mesh = random_2D_mesh_of_elements_around(K, **kwargs)

    space = random_2D_space_of_overall_degrees_around(P)

    return mesh, space



def random_2D_FormCaller_of_total_load_around(*args, **kwargs):
    """A wrapper of `random_3D_mesh_and_space_of_total_load_around` and we use the outputs to make a
    3D FormCaller instance."""
    mesh, space = random_2D_mesh_and_space_of_total_load_around(*args, **kwargs)
...
if __name__ == '__main__':
    ...
    FC = random_2D_FormCaller_of_total_load_around(100)
    mesh = FC._mesh_
    space = FC._space_
