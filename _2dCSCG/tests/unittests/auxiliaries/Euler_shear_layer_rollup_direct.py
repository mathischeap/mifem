...
# mpiexec -n 4 python p2_direct_solver.py
# mpiexec -n 4 python _2dCSCG\APP\__contents__\Euler\shear_layer_rollup\p2_direct_solver.py

import sys
mifem_dir = 'C:/Users/zhang/OneDrive/Codes/mifem'
