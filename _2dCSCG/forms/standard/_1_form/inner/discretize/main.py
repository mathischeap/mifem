...
from _2dCSCG.forms.standard._1_form.inner.discretize.vector.standard import _2dCSCG_S1Fi_Discretize_StandardVector
...
class _2dCSCG_S1Fi_Discretize(FrozenOnly):
    def __init__(self, sf):
        self._sf_ = sf
        self._standard_vector_ = _2dCSCG_S1Fi_Discretize_StandardVector(sf)
        self._freeze_self_()
