...
from _2dCSCG.form.standard.numbering.main import _2dCSCG_Standard_Form_Numbering
from _2dCSCG.form.standard.visualize.main import _2dCSCG_FormVisualize
...
class _2dCSCG_Standard_Form_Coboundary(CSCG_Standard_Form_Coboundary_BASE):
    ...
    def ___PRIVATE_next_class___(self):
        ...
        k = self._sf_.k
        nextPath = f'_2dCSCG.form.standard._{k+1}_form_' + self._sf_.orientation
        nextName = f'_{k+1}Form_'
