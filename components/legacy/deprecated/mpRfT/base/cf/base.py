...
class mpRfT_ContinuousField_Base(FrozenOnly):
    """"""

    def __init__(self, mesh, ftype='standard', valid_time=None, name='scalar-field'):
        """"""
        self._func_ = None # will be set in particular cf (in ___PRIVATE_set_vt_to___).
...
if __name__ == "__main__":
    # mpiexec -n 4 python objects/mpRfT/base/cf/base.py
    pass
