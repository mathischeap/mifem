...
class mpRfT2_Mesh_SegmentIntegral(mpRfT2_CooMapBase):
    """"""
        ...
        for edge in frame:
            ...
            if isinstance(mark, str) and mark in self._segCache_:
                ...
                for seg in segments:
                    ...
                    nodes, weights = Quadrature(N+1, category='Lobatto').quad
...
if __name__ == "__main__":
    # mpiexec -n 4 python objects/mpRfT/_2d/mesh/coo_map/helpers/segment_integral.py
