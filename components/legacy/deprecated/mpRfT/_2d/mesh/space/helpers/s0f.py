...
class mpRfT2_Mesh_Space_S0F_Basis(mpRfT2_Mesh_Space_Basis):
    def __init__(self, mesh, coo_map):
        """"""
        super(mpRfT2_Mesh_Space_S0F_Basis, self).__init__(mesh, coo_map)
        self._freeze_self_()
...
if __name__ == "__main__":
    # mpiexec -n 4 python objects/mpRfT/_2d/mesh/space/helpers/s0f.py
    pass
