...
class _3nCSCG_CellTypeWr2Metric_Base(FrozenOnly):
    """
    ...
    def __eq__(self, other):
        ...
        return self.mark == other.mark and other.___IS_3nCSCG_CellTypeWr2Metric___

    @property
    def ___IS_3nCSCG_CellTypeWr2Metric___(self):
        return True
