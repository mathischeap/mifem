...
class _2nCSCG_RF2_ScalarReconstruct(FrozenOnly):
    ...
    def __call__(self, xi_eta, time=None, where=None, i=None, ravel=False):
        """
    ...
    def ___Pr_standard_cell___(self, xi_eta, ravel, INDICES):
        ...
        xy = self._cf_.mesh.ids('vector', xy, xi_eta.distribution, full)
        value = self._cf_.mesh.ids('scalar', value, xi_eta.distribution, full)
