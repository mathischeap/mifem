...
class _2nCSCG_RF2_OuterStandard0Form(_2nCSCG_RF2_Standard0FormBase):
    """"""
    ...
    def __init__(self, mesh, hybrid=True,
        ...
        name
        """
        super(_2nCSCG_RF2_OuterStandard0Form, self).__init__(mesh, hybrid, 'outer', numbering_parameters, name)
        self.standard_properties.___PRIVATE_add_tag___('_2nCSCG_RF2_standard_outer_0_form')
        self._freeze_self_()
...
if __name__ == '__main__':
    # mpiexec -n 4 python objects/nCSCG/rfT2/_2d/form/standard/_0/outer/main.py
    from objects.nCSCG.rf2._2d.__tests__.Random.mesh import random_mesh_of_elements_around as rm2
    mesh = rm2(100)

    f0 = _2nCSCG_RF2_OuterStandard0Form(mesh)
