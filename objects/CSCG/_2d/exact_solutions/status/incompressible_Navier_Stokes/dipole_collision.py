...
class DipoleCollision(incompressibleNavierStokesBase):
    """"""
    def __init__(self, es, nu=1/625, x1=0, y1=0.1, x2=0, y2=-0.1, r0=0.1, we1=320, we2=-320):
        """
        ...
        super(DipoleCollision, self).__init__(es, nu)
...
if __name__ == '__main__':
    # mpiexec -n 4 python objects/CSCG/_2d/exact_solutions/status/incompressible_Navier_Stokes/dipole_collision.py
