...
class ___2dCSCG_0_o_Form_CrossProduct_0_X_1__ip_1_2M0___(FrozenOnly):
    """To compute (w0 X u1, e1). Cochain of u1 must be known, return mesh-element-wise
    matrices whose columns refer to local cochain of w0, rows' refer to local cochain
    of e1.
    """
    def __init__(self, w0, u1, e1, quad_degree=None):
        ...
        we should do:
            ...
            CP = w0.special.cross_product(u1, e1, output='2-M-0')

        This will give an instance `CP `of this class.
        ...
        assert u1.ndim == w0.ndim == e1.ndim, " <___2dCSCG_0_o_Form_CrossProduct_0_X_1__ip_1_2M0___> "
        assert w0.k+1 == u1.k == e1.k == 1, " <___2dCSCG_0_o_Form_CrossProduct_0_X_1__ip_1_2M0___> "
        assert u1.mesh == w0.mesh, "___2dCSCG_0_o_Form_CrossProduct_0_X_1__ip_1_2M0___: Meshes do not match."
        assert u1.mesh == e1.mesh, "___2dCSCG_0_o_Form_CrossProduct_0_X_1__ip_1_2M0___: Meshes do not match."
