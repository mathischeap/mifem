...
class TaylorGreenVortex(incompressibleNavierStokesBase, ABC):
    ...
    def __init__(self, mesh, nu=0.01):
        ...
        :param nu:
        """
        super(TaylorGreenVortex, self).__init__(mesh, nu)
        # -------- check the domain -------------------------------------------------------
...
if __name__ == '__main__':
    # mpiexec -n 4 python objects/CSCG/_2d/exactSolutions/incompressibleNavierStokes/Taylor_Green_vortex.py
    ...
    es.body_force.visualize(time=10)
