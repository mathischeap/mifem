...
from objects.CSCG._2d.mesh.elements.element.coordinate_transformation.constant import _2dCSCG_Element_Constant
...
class _2dCSCG_Mesh_ECT(FrozenOnly):
    def __init__(self, element):
        ...
        self._origin_ = None
        self._delta_ = None
        self._constant_ = _2dCSCG_Element_Constant(element)
        self._freeze_self_()
