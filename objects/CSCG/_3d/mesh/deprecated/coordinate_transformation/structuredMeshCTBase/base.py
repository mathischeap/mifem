...
from objects.CSCG._3d.mesh.deprecated.coordinate_transformation.structuredMeshCTBase.MODULES.methods import CTMODMethods
from objects.CSCG._3d.mesh.deprecated.coordinate_transformation.structuredMeshCTBase.MODULES.generators import CTMODGenerators
