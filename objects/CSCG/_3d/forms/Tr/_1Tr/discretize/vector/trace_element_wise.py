...
class _3dCSCG_1Tr_Discretize_TraceElementWiseVector(FrozenOnly):
    """"""
    ...
    def __call__(self,
        ...
        if target == 'func':
            ...
            raise NotImplementedError(f"1Trace = discretize_VectorField_standard of ftype "
                                      f"trace-element-wise not applicable for target={target}.")
