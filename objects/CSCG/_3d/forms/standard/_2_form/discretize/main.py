...
from objects.CSCG._3d.forms.standard._2_form.discretize.vector.boundary_wise import _3dCSCG_Discretize_BoundaryWise
from objects.CSCG._3d.forms.standard._2_form.discretize.vector.standard import _3dCSCG_Discretize_Standard
            ...
            if SELF.TW.func.body.__class__.__name__ == '_3dCSCG_VectorField':
                ...
                if SELF.func.ftype == 'standard':
                    ...
                    raise NotImplementedError(f"3dCSCG 2-form cannot (target func) "
                                              f"discretize _3dCSCG_VectorField of ftype={SELF.func.ftype}")
            ...
            if SELF.TW.BC.body.__class__.__name__ == '_3dCSCG_VectorField':
                ...
                if SELF.BC.ftype == 'standard':
                    ...
                    raise NotImplementedError(f"3dCSCG 2-form cannot (target BC) "
                                              f"discretize _3dCSCG_VectorField of ftype={SELF.BC.ftype}")
