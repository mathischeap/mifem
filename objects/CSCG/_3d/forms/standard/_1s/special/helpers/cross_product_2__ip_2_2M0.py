...
class ___3dCSCG_1Form_CrossProduct_2__ip_2_2M0___(FrozenOnly):
    ...
    """
    def __init__(self, w1, u2, e2, quad_degree=None, cache=None):
        """
        (w1 X u2, e2).
        ...
        :param quad_degree:
        :param cache:
            A cache of some intermediate data
        """
    ...
    def __call__(self, i):
        ...
        M = np.einsum('ijk, j -> ki', self._CP_IP_3dM_[i], self._u2_.cochain.local[i], optimize='greedy')
        return csc_matrix(M)
