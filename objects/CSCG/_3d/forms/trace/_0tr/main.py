...
class _3dCSCG_0Trace(_3dCSCG_Standard_Trace, ABC):
    ...
    def visualize(self):
        if self._visualize_ is None:
            self._visualize_ = _3dCSCG_0Trace_Visualize(self)
    ...
    def ___PRIVATE_generate_TEW_mass_matrices___(self):
        ...
        trace-element numbers and values are the mass matrices in the corresponding trace-elements.
        """
        ...
        for i in self.mesh.trace.elements:
            ...
            if isinstance(mark, str) and mark in local_cache:
                # not an id (chaotic) mark, could be cached.
