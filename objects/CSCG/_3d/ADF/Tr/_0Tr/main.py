...
class _3dCSCG_0Tr_ADF(_3dCSCG_ADF_Tr_BASE):
    """
    Dual Tr 0-form.
    ...
    def __init__(self, prime, mesh, space, orientation='outer', name=None):
        """"""
        if name is None: name = orientation + '-oriented-0-AD-Tr'
        super().__init__(3, mesh, space, orientation, name)
        self._prime_ = prime
        self._k_ = 0
        self.standard_properties.___PRIVATE_add_tag___('3dCSCG_standard_algebra_dual_0Tr')
...
if __name__ == "__main__":
    # mpiexec -n 6 python objects\CSCG\_3d\ADF\Tr\_0Tr\main.py
    ...
    ad0 = FC('0-adTr', numbering_parameters={'scheme_name': 'Naive', })
