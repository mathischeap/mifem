...
class incompressible_MHD_Base(Base):
    def __init__(self, es, Re, Rm, c):
        ...
        """
        super(incompressible_MHD_Base, self).__init__(es)
    ...
    def fluid_helicity(self, t):
        """Helicity at time `t`."""
        return self._es_.do.compute_Ln_norm_of('fluid_helicity_distribution', time=t, n=1)
