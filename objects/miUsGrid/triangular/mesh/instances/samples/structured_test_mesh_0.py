...
def Generating_Structured_Triangular_Mesh(K):
    ...
    if RANK == MASTER_RANK:
        ...
        unstructuredGridToVTK(current_dir + f'/structured_tests/structured_test_mesh_01_K{K}',
                              x, y, z, CON, offsets, types)



if __name__ == "__main__":
    # mpiexec -n 4 python objects/miUsGrid/triangular/mesh/instances/samples/structured_test_mesh_0.py
    Generating_Structured_Triangular_Mesh(48)