...
from objects.miUsGrid.triangular.exact_solution.dimensionless_incompressible_Navier_Stokes.base import \
    DimensionlessIncompressibleNavierStokes
from objects.miUsGrid.triangular.fields.vector.main import miUsGrid_Triangular_Vector


class DipoleCollision(DimensionlessIncompressibleNavierStokes):
    """"""
    def __init__(self, mesh, Re=625, x1=0, y1=0.1, x2=0, y2=-0.1, r0=0.1, we1=320, we2=-320):
        """
        ...
        super(DipoleCollision, self).__init__(mesh, Re)
...
if __name__ == '__main__':
    # mpiexec -n 4 python objects/miUsGrid/triangular/exact_solution/dimensionless_incompressible_Navier_Stokes/dipole_collision.py

    from __init__ import miTri

    fc = miTri.call(f'st8', 2)

    es = fc('diNS : dipole collision')
