...
def Generating_Structured_Triangular_Mesh(K):
    ...
    if rAnk == mAster_rank:
        ...
        base_path = str(__file__).split('structured_test_mesh_0')[0]

        unstructuredGridToVTK(base_path + f'structured_tests/structured_test_mesh_01_K{K}',
...
if __name__ == "__main__":
    ...
    Generating_Structured_Triangular_Mesh(256)