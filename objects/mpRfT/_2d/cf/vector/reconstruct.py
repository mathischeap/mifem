...
class mpRfT2_VectorReconstruct(FrozenOnly):
    """"""
    ...
    def ___Pr_standard_cell___(self, xi_eta, ravel, INDICES):
        ...
        assert xi_eta.___Pr_is_mpRfT2_mesh_coo_map___, f"I need a coo distribution object."
        ...
        value = mesh.rcWds.vector(value, 2, xi_eta.distribution, full)
