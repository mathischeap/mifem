...
class mpRfT2_Mesh_LobattoCooMap(mpRfT2_CooMapBase):
    """"""
    ...
    def __getitem__(self, rp):
        ...
        if isinstance(rp, str):
            ...
            if N in self._coo_:
                ...
                _1dNodes, _1dWeights = Quadrature(N + self._dp_, category='Lobatto').quad
        ...
        #------------ else -----------------------------------------------------------------
            ...
            raise NotImplementedError(f'Not implemented Lobatto coo_map for {rp}')
