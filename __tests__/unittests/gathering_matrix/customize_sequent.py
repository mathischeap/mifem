...
class CustomizeSequent(FrozenOnly):
    ...
    def __call__(self):
        ...
        A.customize.identify_global_rows_according_to_miUsGrid_BC(0, f0.BC.interpret)
        A.customize.identify_global_rows_according_to_miUsGrid_BC(1, f1i.BC.interpret)
        A.customize.identify_global_rows_according_to_miUsGrid_BC(2, f1o.BC.interpret)
...
if __name__ == "__main__":
    # mpiexec -n 4 python __tests__/unittests/gathering_matrix/customize_sequent.py
    CustomizeSequent()()
