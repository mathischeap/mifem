...
from TOOLS.__DEPRECATED__.linear_system.lhs_rhs import LHS, RHS
...
class _LinearSystem_Solve(FrozenOnly):
    ...
    def __call__(self, solver_name, routine_name=None):
        ...
        if self._solver_instance_ is None or self._solver_instance_.__class__.__name__ != solver_name:
            self._solver_instance_ = getattr(import_module('TOOLS.__DEPRECATED__.linear_system.solvers'), solver_name)(self._LS_)
        else:
            pass
