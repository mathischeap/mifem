...
from TOOLS.__DEPRECATED__.serial_runners._runner_ import Runner
from TOOLS.__DEPRECATED__.serial_runners.INSTANCES.COMPONENTS.tir_drw import TIR_DRW
from TOOLS.__DEPRECATED__.serial_runners.INSTANCES.COMPONENTS.m_tir_tabular import M_TIR_Tabulate
