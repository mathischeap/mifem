...
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.customize import SpaMat_Customize
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.adjust import SpaMat_Adjust
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.blocks.main import EWC_SpaMat_Blocks
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.condition.main import EWC_SpaMat_Condition

from tools.elementwiseCache.dataStructures.objects.sparseMatrix.helpers.matmul import ___MATMUL___
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.helpers.vecmul import ___VECMUL___
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.helpers.add import ___ADD___
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.helpers.sub import ___SUB___
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.helpers.truediv import ___TRUE_DIV___
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.helpers.transpose import ___TRANSPOSE___
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.helpers.inv import ___LinearAlgebraINV___
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.helpers.neg import ___NEG___
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.helpers.mul import ___MUL___
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.helpers.Psum import SpaMat_PRIVATE_sum

from tools.elementwiseCache.dataStructures.objects.sparseMatrix.assembler import EWC_SparseMatrix_Assembler
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.do import EWC_SparseMatrix_Do
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.whether import EWC_SparseMatrix_Whether
from tools.elementwiseCache.dataStructures.objects.sparseMatrix.visualize import EWC_SparseMatrix_Vis
...
class EWC_SparseMatrix(FrozenOnly):
    ...
    def whether(self):
        ...
        if self._whether_ is None:
            self._whether_ = EWC_SparseMatrix_Whether(self)
