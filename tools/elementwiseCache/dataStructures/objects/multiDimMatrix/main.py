...
from tools.elementwiseCache.dataStructures.objects.multiDimMatrix.do.main import MDM_Do
from tools.elementwiseCache.dataStructures.objects.multiDimMatrix.whether import MDM_Whether
...
class MultiDimMatrix(FrozenOnly):
    def __init__(self, iterator, mdm_generator, correspondence, cache_key_generator):
        ...
        self._whether_ = MDM_Whether(self)
