...
from tools.miLinearAlgebra.solvers.regular.GCROTmk.helpers.scipy_sparse_linalg_gcrotmk import ___sp_sp_linalg_gcrotmk___
...
class GCROTmk(ParallelSolverBase):
    """"""
    ...
    def __call__(
        self, A, b, x0,
        m=20, k=None, maxiter=20, tol=1e-5, atol=1e-4,
        ...
        **kwargs
        ...
        if self._routine_ == 'auto':
            ROUTINE = ___sp_sp_linalg_gcrotmk___
