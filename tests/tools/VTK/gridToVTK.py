...
def TEST_save_CSCG_objects_to_structured_VTK_file():
    ...
    f0 = FC2('0-f-o', hybrid=False, name='pressure')
    f0.CF = scalar
    f0.CF.current_time = 0
    f0.discretize()
    f1i = FC2('1-f-i', hybrid=False, name='Velocity')
    f1i.CF = velocity
    f1i.CF.current_time = 0
    f1i.discretize()
    f1o = FC2('1-f-o', hybrid=False, name='vorticity')
    f1o.CF = velocity
    f1o.CF.current_time = 0
    f1o.discretize()
    f2 = FC2('2-f-o', hybrid=False, name='total pressure')
    f2.CF = scalar
    f2.CF.current_time = 0
    f2.discretize()
