...
import random
import os
from tests.objects.CSCG._3d.randObj.form_caller import random_mesh_of_elements_around
...
def test_Mesh_NO5_mesh_trace_topology():
    ...
    for mid in meshes:
        ...
        for i in mesh.trace.elements:
            ...
            if e.whether.on_mesh_boundary:
                assert e.positions[1] in mesh.domain.boundaries.names
            if e.whether.on_periodic_boundary:
                assert not e.whether.on_mesh_boundary
