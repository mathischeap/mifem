...
def NoHy_TGV_NEW(N=2, k=4, t=15, steps=480, Re=500,
    ...
    u1.CF.current_time = t0
    u2.CF.current_time = t0
    w1.CF.current_time = t0
    w2.CF.current_time = t0
    u1.discretize()
    u2.discretize()
    w1.discretize()
    w2.discretize()
    ...
    du2 = u2.coboundary()
    du2.CF = es.divergence_of_velocity
    du2.CF.current_time = t0
...
if __name__ == '__main__':
    ...
    NoHy_TGV_NEW(N=2, k=3, t=15, steps=600, Re=500, atol=1e-5, restart=300, maxiter=3, save_uw=True)