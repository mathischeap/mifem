...
class miUsGrid_TriangleMesh_ConvergenceTest(FrozenOnly):
    ...
    def __call__(self):
        ...
        try:
            ...
            pr.visualize('loglog', 'N', 'f0i_er', prime='input2', hcp=1, usetex=False,
                         labels=['$N=1$', '$N=2$', '$N=3$', ],
                         styles=["-s", "-v", '-^'],
                         colors=[(0.4, 0.4, 0.4, 1), (0.75, 0.75, 0.75, 1)],
                         title=False,
            ...
            pr.visualize('loglog', 'N', 'f1i_er', prime='input2', hcp=1, usetex=False,
                         labels=['$N=1$', '$N=2$', '$N=3$', ],
                         styles=["-s", "-v", '-^'],
                         colors=[(0.4, 0.4, 0.4, 1), (0.75, 0.75, 0.75, 1)],
                         title=False,
            ...
            pr.visualize('loglog', 'N', 'f1o_er', prime='input2', hcp=1, usetex=False,
                         labels=['$N=1$', '$N=2$', '$N=3$', ],
                         styles=["-s", "-v", '-^'],
                         colors=[(0.4, 0.4, 0.4, 1), (0.75, 0.75, 0.75, 1)],
                         title=False,
            ...
            pr.visualize('loglog', 'N', 'f2i_er', prime='input2', hcp=1, usetex=False,
                         labels=['$N=1$', '$N=2$', '$N=3$', ],
                         styles=["-s", "-v", '-^'],
                         colors=[(0.4, 0.4, 0.4, 1), (0.75, 0.75, 0.75, 1)],
                         title=False,
            ...
            pr.visualize('loglog', 'N', 'df0i_er', prime='input2', hcp=1, usetex=False,
                         labels=['$N=1$', '$N=2$', '$N=3$', ],
                         styles=["-s", "-v", '-^'],
                         colors=[(0.4, 0.4, 0.4, 1), (0.75, 0.75, 0.75, 1)],
                         title=False,
            ...
            pr.visualize('loglog', 'N', 'df0o_er', prime='input2', hcp=1, usetex=False,
                         labels=['$N=1$', '$N=2$', '$N=3$', ],
                         styles=["-s", "-v", '-^'],
                         colors=[(0.4, 0.4, 0.4, 1), (0.75, 0.75, 0.75, 1)],
                         title=False,
            ...
            pr.visualize('loglog', 'N', 'df1i_er', prime='input2', hcp=1, usetex=False,
                         labels=['$N=1$', '$N=2$', '$N=3$', ],
                         styles=["-s", "-v", '-^'],
                         colors=[(0.4, 0.4, 0.4, 1), (0.75, 0.75, 0.75, 1)],
                         title=False,
            ...
            pr.visualize('loglog', 'N', 'df1o_er', prime='input2', hcp=1, usetex=False,
                         labels=['$N=1$', '$N=2$', '$N=3$', ],
                         styles=["-s", "-v", '-^'],
                         colors=[(0.4, 0.4, 0.4, 1), (0.75, 0.75, 0.75, 1)],
                         title=False,
        ...
        try:
            ...
            pr.visualize('semilogy', 'K', 'f0i_er', prime='input2', usetex=False,
                         labels=False,
                         styles=["-v", "-v"],
                         colors=[(0.4, 0.4, 0.4, 1), ], title=False,
                         xlabel=r'$N$',
            ...
            pr.visualize('semilogy', 'K', 'f1i_er', prime='input2', usetex=False,
                         labels=False,
                         styles=["-v", "-v"],
                         colors=[(0.4, 0.4, 0.4, 1), ], title=False,
                         xlabel=r'$N$',
            ...
            pr.visualize('semilogy', 'K', 'f1o_er', prime='input2', usetex=False,
                         labels=False,
                         styles=["-v", "-v"],
                         colors=[(0.4, 0.4, 0.4, 1), ], title=False,
                         xlabel=r'$N$',
            ...
            pr.visualize('semilogy', 'K', 'f2i_er', prime='input2', usetex=False,
                         labels=False,
                         styles=["-v", "-v"],
                         colors=[(0.4, 0.4, 0.4, 1), ], title=False,
                         xlabel=r'$N$',
            ...
            pr.visualize('semilogy', 'K', 'df0i_er', prime='input2', usetex=False,
                         labels=False,
                         styles=["-v", "-v"],
                         colors=[(0.4, 0.4, 0.4, 1), ], title=False,
                         xlabel=r'$N$',
            ...
            pr.visualize('semilogy', 'K', 'df0o_er', prime='input2', usetex=False,
                         labels=False,
                         styles=["-v", "-v"],
                         colors=[(0.4, 0.4, 0.4, 1), ], title=False,
                         xlabel=r'$N$',
            ...
            pr.visualize('semilogy', 'K', 'df1i_er', prime='input2', usetex=False,
                         labels=False,
                         styles=["-v", "-v"],
                         colors=[(0.4, 0.4, 0.4, 1), ], title=False,
                         xlabel=r'$N$',
            ...
            pr.visualize('semilogy', 'K', 'df1o_er', prime='input2', usetex=False,
                         labels=False,
                         styles=["-v", "-v"],
                         colors=[(0.4, 0.4, 0.4, 1), ], title=False,
                         xlabel=r'$N$',
